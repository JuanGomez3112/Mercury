...
import { IconGrid, IconSearch, IconFire, IconInbox, IconBookmark, IconUser, IconTable, IconUsers, IconReels, IconFlag, IconLive } from "./icons";
...
const nav = [
  ...
  { icon: IconLive, label: "En vivo", href: "/en-vivo" },

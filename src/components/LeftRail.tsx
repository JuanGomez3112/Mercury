...
import { IconGrid, IconSearch, IconMasks, IconInbox, IconMapPeople } from "./icons";

const items = [
  { icon: IconGrid, href: "/feed", label: "Inicio", active: true },
  { icon: IconSearch, href: "/feed", label: "Explorar" },
  { icon: IconMasks, href: "/feed", label: "Tabú" },
...
export default function LeftRail() {
  return (
    <nav className="sticky top-24 hidden h-max w-14 shrink-0 flex-col items-center gap-2 lg:flex">

...
export default function PostComposer({
  ...
  return (
    <div className="group flex min-h-[200px] flex-col rounded-none border-x-0 border-y border-white/10 bg-navy-2/50 p-5 transition-colors duration-300 hover:border-purple/20 hover:bg-[#211a48] sm:rounded-2xl sm:border-x sm:p-8">
